...
def save_day_json(records, date_obj):
    ...
    out_path = os.path.join(OUT_DIR, f"Alcazar_Mall_Jubilee_Hills_{date_str}_{run_id}_{job_id}.json")
   #  out_path = os.path.join(OUT_DIR, f"Alcazar_Mall_Jubilee_Hills_{date_str}.json")
