...
def save_day_json(records, date_obj):
    ...
    out_path = os.path.join(OUT_DIR, f"Electronic_City_Phase_1_{date_str}_{run_id}_{job_id}.json")
    #out_path = os.path.join(OUT_DIR, f"Electronic_City_Phase_1_{date_str}.json")
