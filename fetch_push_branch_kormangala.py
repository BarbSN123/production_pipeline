...
branches_config = {
    "14": {   # Branch ID as string This is done
        "name": "Koramangala",
        "slots": {
            "12:00:00": 53, "12:30:00": 53, "13:00:00": 53,
            "13:30:00": 53, "14:00:00": 53, "14:30:00": 54,
            "15:00:00": 54, "15:30:00": 54, "15:45:00": 54,
            "16:30:00": 55,"18:30:00": 55, "19:00:00": 55,
...
def save_day_json(records, date_obj):
    ...
    out_path = os.path.join(OUT_DIR, f"Kormangala_{date_str}_{run_id}_{job_id}.json")
    # out_path = os.path.join(OUT_DIR, f"Kormangala_{date_str}.json")
