...
branches_config = {
    ...
    "147":{
        "name":"Fun Republic Mall, Coimbatore",
        "slots":{
            "12:00:00": 829, "12:30:00": 829, "13:00:00": 829,
            "13:30:00": 829, "14:00:00": 829, "14:30:00": 830,
            "15:00:00": 830, "15:30:00": 830, "15:45:00": 830,
            "18:30:00": 831, "19:00:00": 831,"19:30:00": 831, 
            "20:00:00": 831, "20:30:00": 831,"21:00:00": 832, 
            "21:30:00": 832, "22:00:00": 832,"22:30:00": 832,
            "22:45:00": 832
        }
    }
}
...
def save_day_json(records, date_obj):
    ...
    out_path = os.path.join(OUT_DIR, f"Coimbatore_{date_str}_{run_id}_{job_id}.json")
    #out_path = os.path.join(OUT_DIR, f"Coimbatore_{date_str}.json")
