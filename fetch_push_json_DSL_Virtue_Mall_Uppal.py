...
def save_day_json(records, date_obj):
    ...
    out_path = os.path.join(OUT_DIR, f"DSL_Virtue_Mall_Uppal{date_str}_{run_id}_{job_id}.json")
    #out_path = os.path.join(OUT_DIR, f"DSL_Virtue_Mall_Uppal{date_str}.json")
